...
namespace LearnSchoolApp.Services
{
    public interface IProjectProposalService
    {
        ...
        ProjectProposal Create(ProjectProposal project);
    ...
    {
        private readonly IMongoCollection<ProjectProposal> _project;

        public ProjectProposalService(IProjectProposalDBSettings settings)
        {
            var client = new MongoClient(settings.ConnectionString);
            var database = client.GetDatabase(settings.DatabaseName);
            _project = database.GetCollection<ProjectProposal>(settings.ProjectProposalCollectionName);
        }
        ...
        public ProjectProposal Create(ProjectProposal project)
        {
            try
            {
                Console.WriteLine($"PROPOSAL>> {JsonConvert.SerializeObject(project)}");
