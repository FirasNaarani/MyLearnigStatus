...
{
    public interface IJWTAuthenticationHeadOfDeprament
    {
        string prepareAuthenticationToken(string username, string userType);
    }

    public class JWTAuthenticationHeadOfDeprament : IJWTAuthenticationHeadOfDeprament
    {
        private readonly string tokenKey;

        public JWTAuthenticationHeadOfDeprament(string tokenKey)
        {
